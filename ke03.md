...
### SLR-Parser
SLR steht für simple LR, ein SLR-Parser nutzt das SLR-Verfahren. Beim simple LR (SLR) - Verfahren wird eine LR-Analysetabelle konstruiert.
...
- Allgemeinste Shift-Reduce-Technik die ohne Backtracking auskommt - Man kann sie also genau so effizient implementieren wie andere Shift-Reduce-Verfahren
